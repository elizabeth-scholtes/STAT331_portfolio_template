...
sing_day <- function(dataset, line, phrase_col){
  ...
  #num_word <- c(dataset$Day.in.Words)[line]
  num_filter <- xmas2 |>
    filter(
      Day == line)
  ...
  # Step 2: Sing the gift phrases
    ...
    stringed <- glue::glue_collapse(gifts, sep = "\n")
    
  ## put it together
  return(glue::glue("{intro} {stringed}"))
...
Printing each phrase on its own line and inserting a blank space between the different lines of the song.
...
Ensuring the lines are grammatically correct
...
make_phrase <- function(num_word, item, verb, adjective, location) {
  ...
  # Challenge, adding 'and' and commas
  if(num_word == "two") {
    item <- str_c(item, " and")
  }
  ## Step 4: Glue all of the pieces together! 
  if (str_detect(item, "and|partridge")) {
    return(glue::glue("{num_word} {adjective} {item} {verb} {location}"))
  }
  else {
    return(glue::glue("{num_word} {adjective} {item} {verb}, {location}"))
